...
from lrgb_exps.graphgps.encoder.ast_encoder import ASTNodeEncoder
from lrgb_exps.graphgps.encoder.kernel_pos_encoder import (
    RWSENodeEncoder,
    HKdiagSENodeEncoder,
    ElstaticSENodeEncoder,
)
from lrgb_exps.graphgps.encoder.laplace_pos_encoder import LapPENodeEncoder
from lrgb_exps.graphgps.encoder.ppa_encoder import PPANodeEncoder
from lrgb_exps.graphgps.encoder.signnet_pos_encoder import SignNetNodeEncoder
from lrgb_exps.graphgps.encoder.voc_superpixels_encoder import (
    VOCNodeEncoder,
    COCONodeEncoder,
)
from lrgb_exps.graphgps.encoder.type_dict_encoder import (
    TypeDictNodeEncoder,
    TypeDictEdgeEncoder,
)
from lrgb_exps.graphgps.encoder.linear_node_encoder import LinearNodeEncoder
from lrgb_exps.graphgps.encoder.equivstable_laplace_pos_encoder import (
    EquivStableLapPENodeEncoder,
)
from lrgb_exps.graphgps.encoder.graphormer_encoder import GraphormerEncoder

from lrgb_exps.graphgps.encoder.rwse_edge_encoder import RWSEEdgeEncoder
from lrgb_synth.encoders.encoders import DifferentiableAtomEncoder
...
ds_encs = {
    "Atom": AtomEncoder,
    "AtomDiff": DifferentiableAtomEncoder,
